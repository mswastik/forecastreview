...
co=pn.widgets.Select(name="Select Country",options=['INDIA','CHINA'],value='INDIA',height=40)
fr=pn.widgets.Select(name='Select Franchise',options=['ddd','Joint Replacement'],value='Joint Replacement',height=40)
